...
from train import load_img, make_larger, make_smaller, make_mask, load_batch, load_glyph_nums
...
def main():
    for FONT in ['times_new_roman', 'arial', 'tahoma']:
        for glyph_idx in range(ord('a'), ord('z') + 1):
            ...
            model = tf.keras.models.load_model(f'/home/ubuntu/data/results/memorization_masked_mlp/{FONT}/{EXP_NAME}/model')
            
            root = f'/home/ubuntu/data/ground_truth/{FONT}'
            results_root = f'/home/ubuntu/data/results/memorization_masked_mlp/{FONT}/{EXP_NAME}/results'
