...
def main():
    ...
    for FONT in ['times_new_roman']:
        ...
        #                   *list(map(ord, list(',./?><!@#$%^&*()-=_+')))]:
            ...
            model = tf.keras.models.load_model(f'/home/ubuntu/data/results/implicit_no_freq_encoding/{FONT}/{EXP_NAME}/model')

            root = f'/home/ubuntu/data/ground_truth/{FONT}'
            results_root = f'/home/ubuntu/data/results/implicit_no_freq_encoding/{FONT}/{EXP_NAME}/results'
