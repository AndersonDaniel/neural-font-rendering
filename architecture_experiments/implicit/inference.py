...
def main():
    ...
    for FONT in ['times_new_roman']:
        ...
        for glyph_idx in [*range(ord('A'), ord('Z') + 1), *range(ord('0'), ord('9') + 1),
            ...
            model = tf.keras.models.load_model(f'/home/ubuntu/data/results/implicit/{FONT}/{EXP_NAME}/model')

            root = f'/home/ubuntu/data/ground_truth/{FONT}'
            results_root = f'/home/ubuntu/data/results/implicit/{FONT}/{EXP_NAME}/results'
